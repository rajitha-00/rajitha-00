...
const userStyles =makeStyles(theme =>({
    table:{
        ...
        '& thead th': {
            ...
            backgroundColor: theme.palette.pimary.light,
        },
        '& tbody td':{
            fontWeigt:'300',
        },
...
export default function useTable(records,headCells) {
            ...
            <TableRow>
                {
                    ...
                    sortDirection = {orderBy === headCell.id ?order:false}>
                        ...
                        onClick = {() => {handleSortReqest(headCell.id)}}>
                         { headCells.label}
                        </TableSortLabel>
                    </TableCell>))
                }
    ...
    function desendingComparator(a, b, orderBy){
    ...
    const recordsAfterPagingAndSoting =() => {
